...
7. [Configured Stream Analytics Outputs](#configured-stream-analytics-outputs)
8. [Stream Analytics Job](#stream-analytics-job)
9. [Incoming Data After Running The Stream Analytics Job](#incoming-data-after-running-the-stream-analytics-job)
10. [Data Storage and Batch Processing](#data-storage-and-batch-processing)
11. [Created External Table](#creating-external-table)
12. [Calculated Boat Ranking](#calculating-boat-ranking)
13. [PowerBI Dashboard](#powerbi-dashboard)
14. [Azure Resources Utilized](#azure-resources-utilized)
...
- **Real-time Path:** Used Event Hub and Stream Analytics for real-time data processing.
...
![PowerBI output configuration](https://github.com/Javeria-Umer/Techionista-Vendee-Globe-Race/blob/main/Power%20BI%20output%20configuration.png?raw=true)
...
![datalake container configuration](https://github.com/Javeria-Umer/Techionista-Vendee-Globe-Race/blob/main/datalake%20container%20configuration.png?raw=true)

<br> <!-- HTML line break for spacing -->

## 8. Stream Analytics Job <a name="stream-analytics-job"></a>
...
## 9. Incoming Data After Running The Stream Analytics Job <a name="incoming-data-after-running-the-stream-analytics-job"></a>
- **Event Hub Namespace:**
...
## 11. Created External Table <a name="creating-external-table"></a>
...
## 12. Calculated Boat Ranking <a name="calculating-boat-ranking"></a>
